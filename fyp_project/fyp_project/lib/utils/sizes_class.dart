  ...
  static EdgeInsetsGeometry only(
    ...
    if (withResponsive) {
      return EdgeInsets.only(
          left: MySize2.getScaledSizeHeight(left),
          right: MySize2.getScaledSizeHeight(right),
          top: MySize2.getScaledSizeHeight(top),
          bottom: MySize2.getScaledSizeHeight(bottom));
    } else {
      return EdgeInsets.only(
